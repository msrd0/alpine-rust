...
LABEL org.opencontainers.image.title="alpine-rust (rustc {{ channel }})"
LABEL org.opencontainers.image.description="Alpine Linux based Docker Image with Rust {{ channel }} pre-installed"
